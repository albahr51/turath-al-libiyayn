...
- بحث فوري مبني على فهرس `public/search/search-meta.json` و`public/search/search-text.json` (يُولَّدان أثناء البناء؛ يُحمَّل الأصغر أولًا لعرض النتائج بسرعة ثم تُستكمل المقتطفات).
